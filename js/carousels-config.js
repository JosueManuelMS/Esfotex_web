window.CAROUSEL_IMAGE_CONFIG = {
    "maquina-fade": [
        { src: "img/carouseles/maquina/fade/01.jpg", alt: "Práctica con máquina recta industrial" },
        { src: "img/carouseles/maquina/fade/02.jpg", alt: "Práctica con máquina remalladora industrial" },
        { src: "img/carouseles/maquina/fade/03.png", alt: "Práctica con máquina recubridora industrial" }
    ],
    "maquina-gallery": [
    ...
    "patronaje-fade": [
        ...
        { src: "img/carouseles/patronaje/fade/02.jpg", alt: "Desarrollo de moldes" },
        { src: "img/carouseles/patronaje/fade/03.jpg", alt: "Patronaje en tela" }
    ],
    "patronaje-punto": [
        { src: "img/carouseles/patronaje/punto/01.jpg", alt: "Polo básico" },
        { src: "img/carouseles/patronaje/punto/02.png", alt: "Polo manga larga" },
        { src: "img/carouseles/patronaje/punto/03.jpg", alt: "Leggins" }
    ],
    "patronaje-plana": [
        { src: "img/carouseles/patronaje/plana/01.jpg", alt: "Falda línea A" },
        { src: "img/carouseles/patronaje/plana/02.jpg", alt: "Polo cuello V" },
        { src: "img/carouseles/patronaje/plana/03.jpg", alt: "Vestido" }
    ],
    "patronaje-gallery": [
    ...
    "especializaciones-fade": [
        ...
        { src: "img/carouseles/especializaciones/fade/02.jpg", alt: "Especialización en prendas infantiles" },
    ...
    "diseno-fade": [
        ...
        { src: "img/carouseles/diseno/fade/02.jpeg", alt: "Desarrollo de bocetos y colección" },
